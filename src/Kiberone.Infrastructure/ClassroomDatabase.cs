...
public static class ClassroomDatabase
{
    ...
    private static async Task EnsureGamificationSchemaAsync(ClassroomDbContext db, CancellationToken cancellationToken)
    {
        var statements = new[]
        {
            ...
            ,"""ALTER TABLE quiz_sessions ADD COLUMN CorrectIndicesJson TEXT NOT NULL DEFAULT '[]';"""
            ,"""ALTER TABLE quiz_sessions ADD COLUMN IsMultiple INTEGER NOT NULL DEFAULT 0;"""
            ,"""ALTER TABLE quiz_answers ADD COLUMN SelectedIndicesJson TEXT NOT NULL DEFAULT '[]';"""
